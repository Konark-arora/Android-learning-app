...
public class InAppPurchaseScene {
	...
	private void loadResources() {
		try {
			this.inAppBgTexture = new AssetBitmapTexture(context.getTextureManager(), context.getAssets(), "gfx/in_app_purchase/transparentsheet.png");
			this.inAppBgTextureRegion = TextureRegionFactory.extractFromTexture(this.inAppBgTexture);
			this.inAppBgTexture.load();
			this.inAppBodyBgTexture = new AssetBitmapTexture(context.getTextureManager(), context.getAssets(), "gfx/in_app_purchase/in-app-purchase_dollar.png");
			this.inAppBodyBgTextureRegion = TextureRegionFactory.extractFromTexture(this.inAppBodyBgTexture);
			this.inAppBodyBgTexture.load();
			this.buyBtnBitmapTextureAtlas = new BitmapTextureAtlas(context.getTextureManager(), 256, 128, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
			this.buyBtnTiledTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(buyBtnBitmapTextureAtlas, context.getAssets(), "gfx/in_app_purchase/remove_sprite.png", 0, 0, 2, 1);
			buyBtnBitmapTextureAtlas.load();
			this.restoreBtnBitmapTextureAtlas = new BitmapTextureAtlas(context.getTextureManager(), 256, 128, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
			this.restoreBtnTiledTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(restoreBtnBitmapTextureAtlas, context.getAssets(), "gfx/in_app_purchase/restore_sprite.png", 0, 0, 2, 1);
			restoreBtnBitmapTextureAtlas.load();
			this.closeInAppBitmapTextureAtlass = new BitmapTextureAtlas(context.getTextureManager(), 256, 128, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
			this.closeInAppTiledTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(closeInAppBitmapTextureAtlass, context.getAssets(), "gfx/in_app_purchase/close_sprite.png", 0, 0, 2, 1);
			closeInAppBitmapTextureAtlass.load();
			this.exitGameBitmapTextureAtlass = new BitmapTextureAtlas(context.getTextureManager(), 512, 64, TextureOptions.BILINEAR_PREMULTIPLYALPHA);
			this.exitGameTiledTextureRegion = BitmapTextureAtlasTextureRegionFactory.createTiledFromAsset(exitGameBitmapTextureAtlass, context.getAssets(), "gfx/in_app_purchase/exit-game.png", 0, 0, 2, 1);
	...
	private void loadScene() {
		...
		inAppBgSprite = new Sprite(0, 0, inAppBgTextureRegion, context.getVertexBufferObjectManager());
		...
		closeInAppAnimatedSprite = new AnimatedSprite(inAppBdyBgSprite.getX() + closeInAppTiledTextureRegion.getWidth() / 2, inAppBdyBgSprite.getY() - closeInAppTiledTextureRegion.getHeight() / 3 + 4, closeInAppTiledTextureRegion.deepCopy(), context.getVertexBufferObjectManager()) {
			@Override
		...
		buyBtnAnimatedSprite = new AnimatedSprite(inAppBdyBgSprite.getX() + inAppBdyBgSprite.getWidth() / 2 - buyBtnTiledTextureRegion.getWidth() + 20, inAppBdyBgSprite.getY() + inAppBdyBgSprite.getHeight() - buyBtnTiledTextureRegion.getHeight() / 2, buyBtnTiledTextureRegion.deepCopy(),
		...
		restoreBtnAnimatedSprite = new AnimatedSprite(inAppBdyBgSprite.getX() + inAppBdyBgSprite.getWidth() / 2 + restoreBtnTiledTextureRegion.getWidth() / 2 - 40, inAppBdyBgSprite.getY() + inAppBdyBgSprite.getHeight() - buyBtnTiledTextureRegion.getHeight() / 2,
				restoreBtnTiledTextureRegion.deepCopy(), context.getVertexBufferObjectManager()) {
			@Override
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
				if (pSceneTouchEvent.getAction() == TouchEvent.ACTION_DOWN) {
					this.setCurrentTileIndex(1);
		...
		exitGameBtnAnimatedSprite = new AnimatedSprite(CommonConstants.CAMERA_WIDTH / 2 - exitGameTiledTextureRegion.getWidth() / 2, buyBtnAnimatedSprite.getY() + buyBtnAnimatedSprite.getHeight(), exitGameTiledTextureRegion.deepCopy(), context.getVertexBufferObjectManager()) {
			@Override
			public boolean onAreaTouched(TouchEvent pSceneTouchEvent, float pTouchAreaLocalX, float pTouchAreaLocalY) {
				if (pSceneTouchEvent.getAction() == TouchEvent.ACTION_DOWN) {
					this.setCurrentTileIndex(1);
